<?php
  ...
  $services = array(
      'moodle_gradereport_quizanalytics' => array(                                                // the name of the web service
          'functions' => array ('moodle_quizanalytics_fetchdata'), // web service functions of this service
...
$functions = array(
    'moodle_quizanalytics_fetchdata' => array(
        'classname' => 'moodle_gradereport_quizanalytics_external',
        'methodname' => 'quizanalytics_fetchdata',
