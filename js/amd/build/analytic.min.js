define(['jquery', 'core/ajax', 'core/str'], function ($, ajax, str) {
    return {
        analytic: function () {
            /////////////////////////////////////////////////////////
            const searchBox = document.querySelector("#quizanalytics-filter > div input");
            const rowFilds = document.querySelectorAll(".autolink");
            searchBox.addEventListener("input", () => {
                let searchValue = searchBox.value.trim().toLowerCase();
                rowFilds.forEach((row) => {
                    let text = row.innerText.toLowerCase();
                    if (text.includes(searchValue)) {
                        row.parentNode.parentNode.parentNode.style.display = 'table-row';
                    }
                    else {
